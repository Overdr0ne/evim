;;; evim-geiser.el --- geiser modeset for evim       -*- lexical-binding: t; -*-
...
(evim-define-derived-mode geiser normal)
(evim-define-derived-mode geiser visual)
(evim-define-derived-mode geiser insert)

(defun evim-geiser-escape ()
  (interactive)
  (evim-transition-to 'evim-normal-geiser-mode))

(defun evim-geiser-A ()
  (interactive)
  (end-of-line)
  (evim-transition-to 'evim-insert-geiser-mode))
...
(defun evim--visual-geiser-mode-enable ()
  )
(add-hook 'evim-visual-geiser-mode-on-hook #'evim--visual-geiser-mode-enable)

(defun evim--normal-geiser-mode-enable ()
  )
(add-hook 'evim-normal-geiser-mode-on-hook #'evim--normal-geiser-mode-enable)
...
(defun evim--insert-geiser-mode-disable  ()
  "Switch to line (\"cooked\") sub-mode of geiser mode.
This means that Emacs editing commands work as normally, until
you type \\[term-send-input] which sends the current line to the inferior."
  (interactive)

  (remove-hook 'pre-command-hook #'geiser-set-goto-process-mark t)
  (remove-hook 'post-command-hook #'geiser-goto-process-mark-maybe t))
(add-hook 'evim-insert-geiser-mode-off-hook #'evim--insert-geiser-mode-disable)

(defun evim--insert-geiser-mode-enable ()
  "Switch to char (\"raw\") sub-mode of geiser mode.
...
process."
  ...
  (setq geiser-old-mode-map (current-local-map))
  (use-local-map geiser-raw-map)
